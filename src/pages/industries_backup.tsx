        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">通过FDA、ISO等多项国际认证</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">24小时内响应客户需求</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">产品远销全球50多个国家</p>
            </div>
          </div>
        </div>
      </section>
  ...
  const industries = [
    {
      ...
      name: '食品行业',
      slug: 'food',
      description: '为食品行业提供保鲜、防潮、防氧化的包装解决方案，符合FDA食品安全标准。适用于咖啡、坚果、零食、调味品等各类食品。',
    ...
    },
    {
      ...
      name: '饮料行业',
      slug: 'beverage',
      description: '专为液体产品设计的热门包装方案，包括果汁、饮料、酒类等产品的自立袋和带嘴袋包装。',
      image: '/images/category-placeholder.svg',
    },
    {
      id: 3,
      name: '医药行业',
      slug: 'pharmaceutical',
      description: '符合GMP标准的医药包装解决方案，确保药品安全、防潮、防伪。适用于片剂、胶囊、粉末等药品包装。',
      image: '/images/category-placeholder.svg',
    },
    {
      id: 4,
      name: '化工行业',
      slug: 'chemical',
      description: '耐腐蚀、防泄漏的化工产品包装方案，适用于化工原料、洗涤剂、涂料等产品的包装。',
      image: '/images/category-placeholder.svg',
    },
    {
      id: 5,
      name: '农业行业',
      slug: 'agriculture',
      description: '为种子、肥料、农药等农业产品提供专业包装，具有良好的防潮性和耐用性。',
      image: '/images/category-placeholder.svg',
    },
    {
      id: 6,
      name: '宠物食品',
      slug: 'pet-food',
      description: '专业的宠物食品包装方案，保持食品新鲜度，提供拉链、排气阀等功能性设计。',
      image: '/images/category-placeholder.svg',
    },
  ];
